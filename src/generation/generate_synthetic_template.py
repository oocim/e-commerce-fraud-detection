"""Generate diverse synthetic FRAUD listings using template-based generation.
...
# Each template is 150-250 words to match real listings (avg 720 chars)
GENERIC_DESCRIPTIONS = [
    "Brand new sealed in original packaging. 100% authentic product guaranteed. We offer the best quality at the lowest prices. Fast shipping within 24 hours. Buy with total confidence from our trusted store. Satisfaction guaranteed or your money back. This is the best deal you will find. Limited stock available, order now before it sells out. We have sold thousands of these products and received nothing but positive feedback from our loyal customers. Our products go through rigorous quality checks before being shipped out. Each item is carefully wrapped in protective packaging to ensure it arrives in perfect condition. We offer a hassle-free return policy if you are not completely satisfied. Our customer service team is available 24/7 to assist with any questions or concerns. Don't miss out on this incredible opportunity to own this premium product at a fraction of the retail price.",
    "High quality product at an unbeatable price. We are a reputable seller with years of experience in the industry. This item is exactly as described in the listing. Ships same day from our warehouse. Returns accepted within 30 days for any reason. Don't miss this amazing opportunity to get the best value for your money. Our customers love this product and keep coming back for more. We source our products directly from the manufacturer to eliminate middlemen and pass the savings on to you. Every order is tracked and insured for your peace of mind. We have been selling on this platform for over five years with a stellar track record. Join thousands of satisfied customers who have already discovered the quality and value of our products.",
    "Top-rated product with premium materials and exceptional craftsmanship. Factory direct pricing means huge savings for you compared to retail stores. Each item is carefully inspected by our quality control team before shipping. We guarantee fast delivery and excellent customer service throughout your shopping experience. This is a must-have item at an incredible price point that you will not find anywhere else. Our warehouse processes orders within 2 hours of purchase for lightning-fast delivery. The product comes with a comprehensive user guide and all necessary accessories included in the box. We have partnerships with all major shipping carriers to ensure the fastest possible delivery times. Customer satisfaction is our number one priority and we will go above and beyond to make sure you are happy with your purchase.",
    "Excellent quality guaranteed by our team of product specialists. This product has been tested and verified by our quality control department to meet the highest standards. We stand behind every item we sell with a comprehensive warranty and support program. Free returns if not completely satisfied with your purchase within 60 days. Ships from USA warehouse for fast domestic delivery, usually within 2-3 business days. Our products are sourced from certified manufacturers and come with all original documentation and certificates of authenticity. We offer volume discounts for bulk purchases and can accommodate custom orders. Our dedicated customer support team speaks multiple languages and is available around the clock. Trust us with your purchase and experience the difference that quality and service make.",
    "Amazing deal on this premium quality item that has been a bestseller on our store for months. Perfect as a gift for birthdays, holidays, anniversaries, or just to treat yourself to something special. We offer fast free shipping on all orders and hassle-free returns within 30 days. This item regularly sells for much more at retail stores and specialty shops. Take advantage of this limited time offer before our inventory runs out. We update our stock regularly but popular items like this one tend to sell out quickly. The product features the latest technology and design improvements from the manufacturer. Each unit undergoes a 12-point inspection process to ensure it meets our exacting standards. Packaging includes premium gift-ready presentation with protective foam inserts and branded tissue paper.",
]

# Detailed/specific description templates (more realistic fraud)
# These use template variables to create unique-looking product pages
SPECIFIC_DESCRIPTIONS = [
    "Features advanced {tech} technology for superior performance compared to competing products in the same price range. Built with premium {material} materials for long-lasting durability that will withstand daily wear and tear. {spec1}. {spec2}. Compatible with all major brands and devices on the market. Includes {accessory} in the box along with a comprehensive user manual in multiple languages. {warranty} warranty included with every purchase covering manufacturing defects and workmanship issues. The {year} edition introduces several key improvements including enhanced {feature} and a more refined design. Our engineering team spent over 18 months developing and testing this product to ensure it meets the highest quality standards. Each unit is individually serialized and registered in our quality database for tracking purposes.",
    "Upgraded {year} model with significantly improved {feature} that outperforms the previous generation by up to 40 percent. {spec1}. {spec2}. Designed specifically for {use_case} with an ergonomic form factor that reduces fatigue during extended use sessions. Package includes {accessory} and a detailed quick start guide to get you up and running in minutes. {battery} battery life on a single charge with fast charging support that gets you to 80 percent in just 30 minutes. The sleek new design weighs only {weight} making it one of the lightest options available. {connectivity} connectivity ensures seamless operation with your existing devices and smart home ecosystem. Advanced sensors provide real-time monitoring and automatic adjustments for optimal performance in any environment.",
    "Professional grade {product_type} with {spec1}. {spec2}. Perfect for both beginners and experienced users who demand the best performance from their equipment. Compact and lightweight design at only {weight} makes it perfect for travel and on-the-go use. {connectivity} connectivity ensures seamless operation with smartphones, tablets, and computers. The industrial-grade components are rated for over 50000 hours of continuous operation. Features an intuitive interface with customizable settings and presets for different use scenarios. The product has been certified by multiple international standards organizations including CE, FCC, and RoHS compliance. Includes a premium {accessory} valued at $29.99 as a free bonus with your purchase. Our technical support team is available to help with setup and troubleshooting via phone, email, or live chat.",
    "Next-generation {product_type} featuring revolutionary {tech} technology that sets a new standard in the industry. Precision-engineered with {material} construction for a premium look and feel that rivals products costing three times as much. {spec1}. {spec2}. This {year} release includes an all-new {feature} system that adapts to your personal preferences over time using machine learning algorithms. Battery capacity of {battery} ensures you can use the product all day without worrying about recharging. Compatible with iOS, Android, Windows, and macOS platforms through our free companion app available on all major app stores. In the box you will find the main unit, {accessory}, charging cable, and a microfiber cleaning cloth.",
]
...
def generate_fraud_description():
    """Generate a description that has fraud signals (target: 100-200 words to match real data)."""
    style = random.choices(["generic", "specific", "combined", "short"], weights=[0.35, 0.35, 0.20, 0.10])[0]
    ...
    if style == "generic":
        ...
        # Mix a generic paragraph with a specific paragraph for extra length
        generic = random.choice(GENERIC_DESCRIPTIONS)
        template = random.choice(SPECIFIC_DESCRIPTIONS)
        specific = template.format(
            tech=random.choice(TECH_WORDS),
            material=random.choice(MATERIALS),
            spec1=random.choice(SPECS),
            spec2=random.choice(SPECS),
        ...
        # Very short (suspicious for a real product — small percentage)
        return random.choice([
            "Brand new. Fast shipping. Best price. Buy with confidence from our trusted store.",
            "100% authentic guaranteed. Ships today. Returns accepted within 30 days.",
            "Top quality product. Buy with confidence. Returns accepted. Fast free shipping.",
            "Premium product at wholesale price. Limited stock. Order now.",
            "New in box. Ships same day. Best deal online. Satisfaction guaranteed.",
            "Great product great price. Order now before stock runs out. Fast delivery.",
        ])
